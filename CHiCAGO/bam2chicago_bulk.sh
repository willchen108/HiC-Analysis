...
for i in {1..10}
do
qsub -l mfree=10G /net/shendure/vol1/home/wchen108/tools/chicago/chicagoTools/bam2chicago.sh $projectdir/$i/${NAME[$i]}.$suffix.fixmate.sorted.dedup.RG.sortname.bam $baitmap /net/shendure/vol10/projects/DNaseHiC.eQTLs/data/Dnasemap_hs37d5.rmap $projectdir/$i/Chicago/${NAME[$i]}.$suffix nodelete
done