...
#promoter is 21th and 100kb upstream is [1-20] 100kb downstream is [22-41]. 0 is reads that are >100kb upstream; 42 is >100kb downstream.
	...
	if species in promoters:
		for promoter in promoters[species]:
			...
			if start < fcoord1 < end or start < rcoord1 < end:
				...
				dis = mid - start
				if dis > 0:
					bin = 21 + int(dis/res) + 1
					if bin <= 41:
						promoters[species][promoter][bin] += 1
					else:
						promoters[species][promoter][42] +=1
				else:
					bin = 21 + int(dis/res) - 1
					if bin >= 0:
						promoters[species][promoter][bin] += 1
...
for chrom in promoters:
    ...
    (chrom,promoter[0],promoter[1],s[0],s[1],s[2],s[3],s[4],s[5],s[6],s[7],s[8],s[9],s[10],s[11],s[12],s[13],s[14],s[15],s[16],s[17],s[18],s[19],s[20],s[21],s[22],s[23],s[24],s[25],s[26],s[27],s[28],s[29],s[30],s[31],s[32],s[33],s[34],s[35],s[36],s[37],s[38],s[39],s[40],s[41],s[42])
